...
void setnext()  
    {  
        ...
        try
        {
            pythondb d=new pythondb();
         
          psmt=d.conn.prepareStatement("select * from pythondb");
            if(current==0)  
            {    
                String sql="select * from pythondb where QNum=1"; 
            ...
            if(current==1)  
            {  
                String sql="select * from pythondb where QNum=2";
                 psmt=d.conn.prepareStatement(sql);
                ResultSet rs = psmt.executeQuery(sql);
                if(rs.next()){
                String s1 =rs.getString("Qn");
            ...
            if(current==2)  
            {  
                String sql="select * from pythondb where QNum=3";
                 psmt=d.conn.prepareStatement(sql);
            ...
            if(current==3)  
            {  
                String sql="select * from pythondb where QNum=4";
                 psmt=d.conn.prepareStatement(sql);
                ResultSet rs = psmt.executeQuery();
                if(rs.next()){
            ...
            if(current==4)  
            {  
                String sql="select * from pythondb where QNum=5";
                 psmt=d.conn.prepareStatement(sql);
                ResultSet rs = psmt.executeQuery();
                if(rs.next()){
                String s1 =rs.getString("Qn");
            ...
            if(current==5)  
            {  
                String sql="select * from pythondb where QNum=6";
                 psmt=d.conn.prepareStatement(sql);
                ResultSet rs = psmt.executeQuery();
                if(rs.next()){
                String s1 =rs.getString("Qn");
            ...
            if(current==6)  
            {  
                String sql="select * from pythondb where QNum=7";
                psmt=d.conn.prepareStatement(sql);
                ResultSet rs = psmt.executeQuery();
                if(rs.next()){
                String s1 =rs.getString("Qn");
            ...
            if(current==7)  
            {  
                String sql="select * from pythondb where QNum=8";
                 psmt=d.conn.prepareStatement(sql);
                ResultSet rs = psmt.executeQuery();
                if(rs.next()){
                String s1 =rs.getString("Qn");
            ...
            if(current==8)  
            {  
                String sql="select * from pythondb where QNum=9";
                 psmt=d.conn.prepareStatement(sql);
                ResultSet rs = psmt.executeQuery();
                if(rs.next()){
                String s1 =rs.getString("Qn");
            ...
            if(current==9)  
            {  
                String sql="select * from pythondb where QNum=10";
                psmt=d.conn.prepareStatement(sql);
        ...
        try
        {
            ...
            for(int i=1;i<=10;i++)
            {
                  ...
                  ResultSet rs = psmt.executeQuery();
                    ...
                    String s4 =rs.getString("op3");
                    String s5 =rs.getString("op4");
                    psmt.executeUpdate("insert into pythondb values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"')");
                    rs.close();
                    sql="select * from pythondb where QNum="+i+"";
	...
	void check() {
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/mcq","root","");
			 ...
			 String sq="select corans from pythondb";
